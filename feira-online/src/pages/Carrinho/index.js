...
import { usePagamentocContext } from 'common/context/Pagamento';
...
function Carrinho() {
  ...
  const { tiposPagamento, formaPagamento, mudarFormaPagamento } = usePagamentocContext()
  const history = useHistory()
  //só faz o cálculo se o saldo ou o valor total do carrinho mudar
