...
import { usePagamentocContext } from './Pagamento';
...
export const useCarrinhoContext = () => {
    ...
    function removerProduto(id) {
        const produto = carrinho.find(itemDoCarrinho => itemDoCarrinho.id)
    ...
    //listener, ele vai escutar o carrinho
    useEffect(() => {
